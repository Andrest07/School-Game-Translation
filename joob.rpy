...
translate english shopping_joob_d6b70e8b:
    ...
    "Without any problems entering the room you need, your eyes immediately caught a middle-aged man who understands papers and does not raise his gaze at you, either because of concentration at work, or because of an unwillingness to break away from it."

# game/joob.rpy:287
translate english shopping_joob_9bf16ba9:

    # glgg "Здравствуйте, я здесь насчет объяв..."
    glgg "Hello, I'm here about you..."
...
translate english shopping_joob_7f31a106:
    ...
    "Without letting you finish , the man continued to work enthusiastically with the papers,which continued for another ten minutes . Carefully placing his pen and glasses on the table, the man rubbed his eyes wearily and looked at you sitting on the sofa waiting for your turn, from head to toe."

# game/joob.rpy:291
translate english shopping_joob_97d168e7:

    # adm_magazine "Так вы сказали, что пришли по объявлению?"
    adm_magazine "So you said you were saw the ad?"
...
translate english shopping_joob_205fa6ca:
    ...
    adm_magazine "And how are you going to get a job as a schoolboy without a resume, experience and creativity?"
...
translate english shopping_joob_142e9c4d:
    ...
    "Having said this, you have literally put an end to this job, which is what the threatening look of the employer said."
...
translate english shopping_joob_7ade2a0a:
    ...
    "Having decided not to make the situation worse, you left the office without a job, humiliated, and even penniless."
...
translate english shopping_joob_e873ad51:
    ...
    "After your answer, you noticed a small spark of curiosity in the eyes of the man who got up from his already-settled place, taking the questionnaire with him from the table. When he came up to you, he handed you a piece of paper, which you immediately took."
...
translate english shopping_joob_18a7e3e0:
    ...
    adm_magazine "You know , I've always appreciated honesty in people. In my entire career, only a few people have said this, but the other part has boasted about the same qualities that, oddly enough , no one else has. My managerial experience tells me that you will definitely not let me down!"
...
translate english shopping_joob_d4898887:
    ...
    "After patting you on the shoulder a few times roughly and quite forcefully, your new employer sat down on the sofa opposite and watched your actions with interest."

# game/joob.rpy:314
translate english shopping_joob_6c576a5b:

    # glgg "Можно поподробнее узнать о вакансии?"
    glgg "Can I find out more about the job?"
...
translate english shopping_joob_fbbae9d4:
    ...
    adm_magazine "Of course! In short and clear terms, we need a product sorter. The work is not dusty and, accordingly, low-paid: 350-450 credits per working day, depending on the work performed."
...
translate english shopping_joob_f6cdded4:
    ...
    adm_magazine "There is a career progression to a Manager who already receives a fixed percentage of sales as a salary."
...
translate english shopping_joob_1095e05a:
    ...
    adm_magazine "The schedule is simple to the point of ugliness: you need to work all week for 4 hours , except Sundays. As a plus, it is also completely free, that is, work even at night, even in the morning, even in the afternoon."
...
translate english shopping_joob_0a994909:
    ...
    adm_magazine "The main thing is that you sort out all the goods in these 4 hours: overdue products was removed from the Windows, the new product was put behind the old one, and then, I think, you understand. The usual tricks of supermarkets and hypermarkets."
...
translate english shopping_joob_f7c7a22d:
    ...
    adm_magazine "Great! I never doubted you! Fill out the form, I will put a stamp and consider that you are already an employee of this store."
...
translate english shopping_joob_2278e70d:
    ...
    "Looking at the form, you saw an ordinary bureaucratic form where you need to write down your name, address, and phone number. With a puzzled shrug and a pen from his rucksack, all the information was signed with rapid movements and a signature was placed at the end ."

# game/joob.rpy:325
translate english shopping_joob_327b2851:

    # adm_magazine "А ты достаточно быстро все сделал."
    adm_magazine "You did it fast enough."

# game/joob.rpy:326
translate english shopping_joob_cc0638b1:

    # "Взяв уже заполненную анкету в руки, мужчина перечитал все и довольно улыбнулся."
    "Taking the already completed form in his hands, the man reread everything and smiled contentedly."
...
translate english shopping_joob_51ab50c7:
    ...
    guide4 "Ooh... A fairly sure step: find a job! With her you will definitely not have problems with money!"
...
translate english shopping_joob_d229b842:
    ...
    guide10 "Ouch... Again I said too much! I'm here to explain the mechanics of the mini-game to you!"
...
translate english shopping_joob_86452ac6:
    ...
    guide1 "In General, look! In different parts of the screen, different icons of available products will appear, which you will click on. One click will give you extra time and victory points, for which you can later get bonuses."
...
translate english shopping_joob_63595fe1:
    ...
    guide2 "Oh... I forgot to mention skills! For each fully worked day, you will receive a skill increase!"
...
translate english shopping_joob_b360084a:
    ...
    guide1 "For each skill level, you will receive not only an increase in bonuses, but also small permanent boosts to attributes!"
...
translate english strings:
    ...
    new "{color=#000000}I am purposeful and always achieve my goals. I think this job will unlock my full potential.\n{size=21}{i}0 power{/i}{/size}{/color}"
    ...
    new "{color=#000000}I'm quite an interesting person.\n{size=21}{i}0 power{/i}{/size}{/color}"

    # game/joob.rpy:319
    old "{color=#000000}Вполне себе неплохо!\n{size=21}{i}50 энергии{/i}{/size}{/color}"
    new "{color=#000000}Pretty good!\n{size=21}{i}50 power{/i}{/size}{/color}"
